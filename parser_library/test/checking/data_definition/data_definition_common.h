...
inline data_definition_operand setup_data_def_op(char type, char extension, int32_t length)
{
...
inline data_definition_operand setup_data_def_op(
    char type, char extension, std::variant<std::string, nominal_value_expressions> nominal)
{
    data_definition_operand op = setup_data_def_op(type, extension);
...
inline data_definition_operand setup_data_def_op(
    char type, char extension, std::variant<std::string, nominal_value_expressions> nominal, int32_t length)
{
...
inline nominal_value_expressions setup_expressions() { return nominal_value_expressions(); }

template<typename... values>
inline nominal_value_expressions setup_expressions(int32_t value, expr_type type, const values&... rest)
{
...
template<typename... values>
inline data_definition_operand setup_data_def_expr_op(char type, char extension, const values&... expr_values_and_types)
{
...
template<typename... values>
inline data_definition_operand setup_data_def_expr_op_length(
    char type, char extension, int32_t length, const values&... expr_values_and_types)
{
    nominal_value_expressions op = setup_expressions(expr_values_and_types...);
...
inline data_def_address make_data_def_address(int32_t base, int32_t disp)
{
    return data_def_address { data_def_field(true, base, range()), data_def_field(true, disp, range()) };
}

inline nominal_value_expressions setup_addresses() { return nominal_value_expressions(); }

template<typename... values>
inline nominal_value_expressions setup_addresses(int32_t base, int32_t disp, const values&... rest)
{
...
template<typename... values>
inline data_definition_operand setup_data_def_addr_op(char type, char extension, const values&... expr_addresses)
{
