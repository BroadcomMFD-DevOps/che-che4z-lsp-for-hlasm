...
A        DC C
    ...
    EXPECT_EQ(d.related[0].location.uri, "AINSERT_1.hlasm");
...
TEST(ainsert, grammar_non_matching_apostrophes_by_one_01)
{
    ...
    EXPECT_TRUE(matches_message_codes(a.diags(), { "A011", "S0003" }));
}
...
TEST(ainsert, grammar_non_matching_apostrophes_by_one_02)
{
    ...
    EXPECT_TRUE(matches_message_codes(a.diags(), { "S0003", "A011" }));
}
