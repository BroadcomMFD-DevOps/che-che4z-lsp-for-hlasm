...
struct test_context : public dependency_solver
{
    ...
    {
        return std::make_unique<mach_expr_symbol>(id(n), q.empty() ? id_storage::empty_id : id(q), range());
    }
...
TEST(using, basic)
{
    ...
    EXPECT_EQ(coll.evaluate(with_sect, id_storage::empty_id, sect, 0, false), evaluate_result(1, 0));
    EXPECT_EQ(coll.evaluate(with_sect, c.id("LABEL"), sect, 0, false), evaluate_result(invalid_register, 0));
    EXPECT_EQ(coll.evaluate(with_sect, id_storage::empty_id, sect, 1000, false), evaluate_result(1, 1000));
    EXPECT_EQ(coll.evaluate(with_sect, id_storage::empty_id, sect, 4096, false), evaluate_result(invalid_register, 1));
    EXPECT_EQ(coll.evaluate(with_sect, id_storage::empty_id, sect, -1, false), evaluate_result(invalid_register, -1));
    EXPECT_EQ(coll.evaluate(with_sect, id_storage::empty_id, sect, 4096, true), evaluate_result(1, 4096));
    EXPECT_EQ(coll.evaluate(with_sect, id_storage::empty_id, sect, -1, true), evaluate_result(1, -1));
}
...
TEST(using, multiple_registers)
{
    ...
    EXPECT_EQ(coll.evaluate(with_sect, id_storage::empty_id, sect, 0, false), evaluate_result(2, 0));
    EXPECT_EQ(coll.evaluate(with_sect, id_storage::empty_id, sect, 4096, false), evaluate_result(1, 0));
    EXPECT_EQ(coll.evaluate(with_sect, id_storage::empty_id, sect, 4100, false), evaluate_result(1, 4));
    EXPECT_EQ(coll.evaluate(with_sect, id_storage::empty_id, sect, 8192, false), evaluate_result(invalid_register, 1));

    EXPECT_EQ(coll.evaluate(with_sect, id_storage::empty_id, sect, 0, true), evaluate_result(2, 0));
    EXPECT_EQ(coll.evaluate(with_sect, id_storage::empty_id, sect, 4096, true), evaluate_result(1, 0));
    EXPECT_EQ(coll.evaluate(with_sect, id_storage::empty_id, sect, 4100, true), evaluate_result(1, 4));
    EXPECT_EQ(coll.evaluate(with_sect, id_storage::empty_id, sect, 8192, true), evaluate_result(1, 4096));
}
...
TEST(using, with_offset)
{
    ...
    EXPECT_EQ(coll.evaluate(with_sect, id_storage::empty_id, sect, 0, false), evaluate_result(invalid_register, -10));
    EXPECT_EQ(coll.evaluate(with_sect, id_storage::empty_id, sect, 10, false), evaluate_result(2, 0));
    EXPECT_EQ(coll.evaluate(with_sect, id_storage::empty_id, sect, 20, false), evaluate_result(2, 10));
    EXPECT_EQ(coll.evaluate(with_sect, id_storage::empty_id, sect, 4106, false), evaluate_result(invalid_register, 1));
    EXPECT_EQ(coll.evaluate(with_sect, id_storage::empty_id, sect, 0, true), evaluate_result(2, -10));
}
...
TEST(using, with_negative_offset)
{
    ...
    EXPECT_EQ(coll.evaluate(with_sect, id_storage::empty_id, sect, -20, false), evaluate_result(invalid_register, -10));
    EXPECT_EQ(coll.evaluate(with_sect, id_storage::empty_id, sect, -10, false), evaluate_result(2, 0));
    EXPECT_EQ(coll.evaluate(with_sect, id_storage::empty_id, sect, 0, false), evaluate_result(2, 10));
    EXPECT_EQ(coll.evaluate(with_sect, id_storage::empty_id, sect, 10, false), evaluate_result(2, 20));
    EXPECT_EQ(coll.evaluate(with_sect, id_storage::empty_id, sect, 20, false), evaluate_result(2, 30));
    EXPECT_EQ(coll.evaluate(with_sect, id_storage::empty_id, sect, 4086, false), evaluate_result(invalid_register, 1));
    EXPECT_EQ(coll.evaluate(with_sect, id_storage::empty_id, sect, -20, true), evaluate_result(2, -10));
    EXPECT_EQ(coll.evaluate(with_sect, id_storage::empty_id, sect, -10, true), evaluate_result(2, 0));
    EXPECT_EQ(coll.evaluate(with_sect, id_storage::empty_id, sect, 0, true), evaluate_result(2, 10));
    EXPECT_EQ(coll.evaluate(with_sect, id_storage::empty_id, sect, 4086, false), evaluate_result(invalid_register, 1));
}
...
TEST(using, dependent_using)
{
    ...
    EXPECT_EQ(coll.evaluate(with_sect, id_storage::empty_id, sect, 10, false), evaluate_result(12, 0));
    EXPECT_EQ(coll.evaluate(with_sect, id_storage::empty_id, sect, 20, false), evaluate_result(12, 10));
    EXPECT_EQ(coll.evaluate(with_sect, id_storage::empty_id, sect2, 20, false), evaluate_result(invalid_register, 0));
    EXPECT_EQ(coll.evaluate(with_sect2, id_storage::empty_id, sect2, 20, false), evaluate_result(12, 25));

    EXPECT_EQ(coll.evaluate(with_sect, id_storage::empty_id, sect, 4105, false), evaluate_result(12, 4095));
    EXPECT_EQ(coll.evaluate(with_sect, id_storage::empty_id, sect, 4106, false), evaluate_result(invalid_register, 1));
    EXPECT_EQ(coll.evaluate(with_sect2, id_storage::empty_id, sect, 4105, false), evaluate_result(12, 4095));
    EXPECT_EQ(coll.evaluate(with_sect2, id_storage::empty_id, sect, 4106, false), evaluate_result(invalid_register, 1));

    EXPECT_EQ(coll.evaluate(with_sect2, id_storage::empty_id, sect2, 4090, false), evaluate_result(12, 4095));
    EXPECT_EQ(
        coll.evaluate(with_sect2, id_storage::empty_id, sect2, 4091, false), evaluate_result(invalid_register, 1));
}
...
TEST(using, labeled)
{
    ...
    EXPECT_EQ(coll.evaluate(with_sect, id_storage::empty_id, sect, 0, false), evaluate_result(invalid_register, 0));
    ...
    EXPECT_EQ(coll.evaluate(with_sect, id_storage::empty_id, sect, 1000, false), evaluate_result(invalid_register, 0));
...
TEST(using, drop_one)
{
    ...
    EXPECT_EQ(
        coll.evaluate(after_drop2, id_storage::empty_id, sect, 0, false), evaluate_result(invalid_register, -4096));
    EXPECT_EQ(coll.evaluate(after_drop2, id_storage::empty_id, sect, 4096, false), evaluate_result(1, 0));
    EXPECT_EQ(coll.evaluate(after_drop2, id_storage::empty_id, sect, 4100, false), evaluate_result(1, 4));
    EXPECT_EQ(
        coll.evaluate(after_drop2, id_storage::empty_id, sect, 8192, false), evaluate_result(invalid_register, 1));

    EXPECT_EQ(coll.evaluate(after_drop2, id_storage::empty_id, sect, 0, true), evaluate_result(1, -4096));
    EXPECT_EQ(coll.evaluate(after_drop2, id_storage::empty_id, sect, 4096, true), evaluate_result(1, 0));
    EXPECT_EQ(coll.evaluate(after_drop2, id_storage::empty_id, sect, 4100, true), evaluate_result(1, 4));
    EXPECT_EQ(coll.evaluate(after_drop2, id_storage::empty_id, sect, 8192, true), evaluate_result(1, 4096));
}
...
TEST(using, drop_dependent)
{
    ...
    EXPECT_EQ(coll.evaluate(with_sect, id_storage::empty_id, sect, 0, false), evaluate_result(2, 0));
    EXPECT_EQ(coll.evaluate(with_sect, id_storage::empty_id, sect2, 0, false), evaluate_result(invalid_register, 0));
    EXPECT_EQ(coll.evaluate(with_sect2, id_storage::empty_id, sect, 0, false), evaluate_result(2, 0));
    EXPECT_EQ(coll.evaluate(with_sect2, id_storage::empty_id, sect2, 0, false), evaluate_result(2, 0));

    EXPECT_EQ(coll.evaluate(after_drop2, id_storage::empty_id, sect, 0, false), evaluate_result(invalid_register, 0));
    EXPECT_EQ(coll.evaluate(after_drop2, id_storage::empty_id, sect2, 0, false), evaluate_result(invalid_register, 0));
}
...
TEST(using, override_label)
{
    ...
    EXPECT_EQ(coll.evaluate(with_sect, id_storage::empty_id, sect, 0, false), evaluate_result(invalid_register, 0));
    EXPECT_EQ(coll.evaluate(with_sect2, id_storage::empty_id, sect, 0, false), evaluate_result(invalid_register, 0));
    EXPECT_EQ(coll.evaluate(with_sect, id_storage::empty_id, sect2, 0, false), evaluate_result(invalid_register, 0));
    EXPECT_EQ(coll.evaluate(with_sect2, id_storage::empty_id, sect2, 0, false), evaluate_result(invalid_register, 0));
...
TEST(using, basic_with_limit)
{
    ...
    EXPECT_EQ(coll.evaluate(with_sect, id_storage::empty_id, sect, 0, false), evaluate_result(1, 0));
    EXPECT_EQ(coll.evaluate(with_sect, id_storage::empty_id, sect, 9, false), evaluate_result(1, 9));
    EXPECT_EQ(coll.evaluate(with_sect, id_storage::empty_id, sect, 20, false), evaluate_result(invalid_register, 11));
}
...
TEST(using, absolute)
{
    ...
    EXPECT_EQ(coll.evaluate(with_sect, id_storage::empty_id, nullptr, 0, false), evaluate_result(0, 0));
    EXPECT_EQ(coll.evaluate(with_sect, id_storage::empty_id, nullptr, 10, false), evaluate_result(0, 10));
    EXPECT_EQ(coll.evaluate(with_sect, id_storage::empty_id, nullptr, 128, false), evaluate_result(1, 0));
    EXPECT_EQ(coll.evaluate(with_sect, id_storage::empty_id, nullptr, 256, false), evaluate_result(1, 128));
    EXPECT_EQ(coll.evaluate(with_sect, id_storage::empty_id, nullptr, -100, true), evaluate_result(0, -100));
}
...
TEST(using, smaller_offset_but_invalid)
{
    ...
    EXPECT_EQ(coll.evaluate(with_sect2, id_storage::empty_id, sect, 128, false), evaluate_result(1, 128));
}
