...
public:
    ...
    */
    static diagnostic_s error_L0001(const utils::resource::resource_location& config_loc, std::string_view path);

    static diagnostic_s error_L0002(const utils::resource::resource_location& config_loc, std::string_view path);

    static diagnostic_s warning_L0003(const utils::resource::resource_location& config_loc, std::string_view path);

    static diagnostic_s warning_L0004(
