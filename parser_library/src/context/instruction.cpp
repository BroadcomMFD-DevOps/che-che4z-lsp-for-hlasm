...
std::string_view instruction_sets::mach_format_to_string(mach_format f)
{
    switch (f)
    {
        case mach_format::E:
...
constexpr machine_instruction machine_instructions[] = {
    ...
    { "LDEB", RRE_2, 1464, UNI_ESA_SINCE_ZOP },
    ...
    { "LXDB", RRE_2, 1464, UNI_ESA_SINCE_ZOP },
    ...
    { "LXEB", RRE_2, 1464, UNI_ESA_SINCE_ZOP },
    ...
    { "RNSBGT", RIE_f_5, 845, UNI_SINCE_Z10 },
    { "ROSBG", RIE_f_5, 846, UNI_SINCE_Z10 },
    { "ROSBGT", RIE_f_5, 858, UNI_SINCE_Z10 },
    ...
    { "RXSBGT", RIE_f_5, 846, UNI_SINCE_Z10 },
...
constexpr mnemonic_code mnemonic_codes[] = {
    { "B", mi_BC, { { 0, 15 } }, UNI_ESA_XA_370_DOS_SINCE_ZOP },
    { "BE", mi_BC, { { 0, 8 } }, UNI_ESA_XA_370_DOS_SINCE_ZOP },
    { "BER", mi_BCR, { { 0, 8 } }, UNI_ESA_XA_370_DOS_SINCE_ZOP },
    { "BH", mi_BC, { { 0, 2 } }, UNI_ESA_XA_370_DOS_SINCE_ZOP },
    { "BHR", mi_BCR, { { 0, 2 } }, UNI_ESA_XA_370_DOS_SINCE_ZOP },
    { "BI", mi_BIC, { { 0, 15 } }, UNI_SINCE_Z14 },
    { "BIE", mi_BIC, { { 0, 8 } }, UNI_SINCE_Z14 },
    { "BIH", mi_BIC, { { 0, 2 } }, UNI_SINCE_Z14 },
    { "BIL", mi_BIC, { { 0, 4 } }, UNI_SINCE_Z14 },
    { "BIM", mi_BIC, { { 0, 4 } }, UNI_SINCE_Z14 },
    { "BINE", mi_BIC, { { 0, 7 } }, UNI_SINCE_Z14 },
    { "BINH", mi_BIC, { { 0, 13 } }, UNI_SINCE_Z14 },
    { "BINL", mi_BIC, { { 0, 11 } }, UNI_SINCE_Z14 },
    { "BINM", mi_BIC, { { 0, 11 } }, UNI_SINCE_Z14 },
    { "BINO", mi_BIC, { { 0, 14 } }, UNI_SINCE_Z14 },
    { "BINP", mi_BIC, { { 0, 13 } }, UNI_SINCE_Z14 },
    { "BINZ", mi_BIC, { { 0, 7 } }, UNI_SINCE_Z14 },
    { "BIO", mi_BIC, { { 0, 1 } }, UNI_SINCE_Z14 },
    { "BIP", mi_BIC, { { 0, 2 } }, UNI_SINCE_Z14 },
    { "BIZ", mi_BIC, { { 0, 8 } }, UNI_SINCE_Z14 },
    { "BL", mi_BC, { { 0, 4 } }, UNI_ESA_XA_370_DOS_SINCE_ZOP },
    { "BLR", mi_BCR, { { 0, 4 } }, UNI_ESA_XA_370_DOS_SINCE_ZOP },
    { "BM", mi_BC, { { 0, 4 } }, UNI_ESA_XA_370_DOS_SINCE_ZOP },
    { "BMR", mi_BCR, { { 0, 4 } }, UNI_ESA_XA_370_DOS_SINCE_ZOP },
    { "BNE", mi_BC, { { 0, 7 } }, UNI_ESA_XA_370_DOS_SINCE_ZOP },
    { "BNER", mi_BCR, { { 0, 7 } }, UNI_ESA_XA_370_DOS_SINCE_ZOP },
    { "BNH", mi_BC, { { 0, 13 } }, UNI_ESA_XA_370_DOS_SINCE_ZOP },
    { "BNHR", mi_BCR, { { 0, 13 } }, UNI_ESA_XA_370_DOS_SINCE_ZOP },
    { "BNL", mi_BC, { { 0, 11 } }, UNI_ESA_XA_370_DOS_SINCE_ZOP },
    ...
    { "BNO", mi_BC, { { 0, 14 } }, UNI_ESA_XA_370_DOS_SINCE_ZOP },
    { "BNOR", mi_BCR, { { 0, 14 } }, UNI_ESA_XA_370_DOS_SINCE_ZOP },
    { "BNP", mi_BC, { { 0, 13 } }, UNI_ESA_XA_370_DOS_SINCE_ZOP },
    { "BNPR", mi_BCR, { { 0, 13 } }, UNI_ESA_XA_370_DOS_SINCE_ZOP },
    { "BNZ", mi_BC, { { 0, 7 } }, UNI_ESA_XA_370_DOS_SINCE_ZOP },
    { "BNZR", mi_BCR, { { 0, 7 } }, UNI_ESA_XA_370_DOS_SINCE_ZOP },
    { "BO", mi_BC, { { 0, 1 } }, UNI_ESA_XA_370_DOS_SINCE_ZOP },
    { "BOR", mi_BCR, { { 0, 1 } }, UNI_ESA_XA_370_DOS_SINCE_ZOP },
    { "BP", mi_BC, { { 0, 2 } }, UNI_ESA_XA_370_DOS_SINCE_ZOP },
    { "BPR", mi_BCR, { { 0, 2 } }, UNI_ESA_XA_370_DOS_SINCE_ZOP },
    { "BR", mi_BCR, { { 0, 15 } }, UNI_ESA_XA_370_DOS_SINCE_ZOP },
    { "BRE", mi_BRC, { { 0, 8 } }, UNI_ESA_SINCE_ZOP },
    { "BREL", mi_BRCL, { { 0, 8 } }, UNI_SINCE_ZOP },
    { "BRH", mi_BRC, { { 0, 2 } }, UNI_ESA_SINCE_ZOP },
    { "BRHL", mi_BRCL, { { 0, 2 } }, UNI_SINCE_ZOP },
    { "BRL", mi_BRC, { { 0, 4 } }, UNI_ESA_SINCE_ZOP },
    { "BRLL", mi_BRCL, { { 0, 4 } }, UNI_SINCE_ZOP },
    { "BRM", mi_BRC, { { 0, 4 } }, UNI_ESA_SINCE_ZOP },
    { "BRML", mi_BRCL, { { 0, 4 } }, UNI_SINCE_ZOP },
    { "BRNE", mi_BRC, { { 0, 7 } }, UNI_ESA_SINCE_ZOP },
    { "BRNEL", mi_BRCL, { { 0, 7 } }, UNI_SINCE_ZOP },
    { "BRNH", mi_BRC, { { 0, 13 } }, UNI_ESA_SINCE_ZOP },
    { "BRNHL", mi_BRCL, { { 0, 13 } }, UNI_SINCE_ZOP },
    { "BRNL", mi_BRC, { { 0, 11 } }, UNI_ESA_SINCE_ZOP },
    { "BRNLL", mi_BRCL, { { 0, 11 } }, UNI_SINCE_ZOP },
    { "BRNM", mi_BRC, { { 0, 11 } }, UNI_ESA_SINCE_ZOP },
    { "BRNML", mi_BRCL, { { 0, 11 } }, UNI_SINCE_ZOP },
    { "BRNO", mi_BRC, { { 0, 14 } }, UNI_ESA_SINCE_ZOP },
    { "BRNOL", mi_BRCL, { { 0, 14 } }, UNI_SINCE_ZOP },
    { "BRNP", mi_BRC, { { 0, 13 } }, UNI_ESA_SINCE_ZOP },
    { "BRNPL", mi_BRCL, { { 0, 13 } }, UNI_SINCE_ZOP },
    { "BRNZ", mi_BRC, { { 0, 7 } }, UNI_ESA_SINCE_ZOP },
    { "BRNZL", mi_BRCL, { { 0, 7 } }, UNI_SINCE_ZOP },
    { "BRO", mi_BRC, { { 0, 1 } }, UNI_ESA_SINCE_ZOP },
    { "BROL", mi_BRCL, { { 0, 1 } }, UNI_SINCE_ZOP },
    { "BRP", mi_BRC, { { 0, 2 } }, UNI_ESA_SINCE_ZOP },
    { "BRPL", mi_BRCL, { { 0, 2 } }, UNI_SINCE_ZOP },
    { "BRU", mi_BRC, { { 0, 15 } }, UNI_ESA_SINCE_ZOP },
    { "BRUL", mi_BRCL, { { 0, 15 } }, UNI_SINCE_ZOP },
    { "BRZ", mi_BRC, { { 0, 8 } }, UNI_ESA_SINCE_ZOP },
    { "BRZL", mi_BRCL, { { 0, 8 } }, UNI_SINCE_ZOP },
    { "BZ", mi_BC, { { 0, 8 } }, UNI_ESA_XA_370_DOS_SINCE_ZOP },
    { "BZR", mi_BCR, { { 0, 8 } }, UNI_ESA_XA_370_DOS_SINCE_ZOP },
    ...
    { "J", mi_BRC, { { 0, 15 } }, UNI_ESA_SINCE_ZOP },
    ...
    { "JE", mi_BRC, { { 0, 8 } }, UNI_ESA_SINCE_ZOP },
    { "JH", mi_BRC, { { 0, 2 } }, UNI_ESA_SINCE_ZOP },
    { "JL", mi_BRC, { { 0, 4 } }, UNI_ESA_SINCE_ZOP },
    { "JLE", mi_BRCL, { { 0, 8 } }, UNI_SINCE_ZOP },
    { "JLH", mi_BRCL, { { 0, 2 } }, UNI_SINCE_ZOP },
    { "JLL", mi_BRCL, { { 0, 4 } }, UNI_SINCE_ZOP },
    { "JLM", mi_BRCL, { { 0, 4 } }, UNI_SINCE_ZOP },
    { "JLNE", mi_BRCL, { { 0, 7 } }, UNI_SINCE_ZOP },
    { "JLNH", mi_BRCL, { { 0, 13 } }, UNI_SINCE_ZOP },
    { "JLNL", mi_BRCL, { { 0, 11 } }, UNI_SINCE_ZOP },
    { "JLNM", mi_BRCL, { { 0, 11 } }, UNI_SINCE_ZOP },
    { "JLNO", mi_BRCL, { { 0, 14 } }, UNI_SINCE_ZOP },
    { "JLNOP", mi_BRCL, { { 0, 0 } }, UNI_ESA_SINCE_ZOP },
    { "JLNP", mi_BRCL, { { 0, 13 } }, UNI_SINCE_ZOP },
    { "JLNZ", mi_BRCL, { { 0, 7 } }, UNI_SINCE_ZOP },
    { "JLO", mi_BRCL, { { 0, 1 } }, UNI_SINCE_ZOP },
    { "JLP", mi_BRCL, { { 0, 2 } }, UNI_SINCE_ZOP },
    { "JLU", mi_BRCL, { { 0, 15 } }, UNI_SINCE_ZOP },
    { "JLZ", mi_BRCL, { { 0, 8 } }, UNI_SINCE_ZOP },
    { "JM", mi_BRC, { { 0, 4 } }, UNI_ESA_SINCE_ZOP },
    { "JNE", mi_BRC, { { 0, 7 } }, UNI_ESA_SINCE_ZOP },
    { "JNH", mi_BRC, { { 0, 13 } }, UNI_ESA_SINCE_ZOP },
    { "JNL", mi_BRC, { { 0, 11 } }, UNI_ESA_SINCE_ZOP },
    { "JNM", mi_BRC, { { 0, 11 } }, UNI_ESA_SINCE_ZOP },
    { "JNO", mi_BRC, { { 0, 14 } }, UNI_ESA_SINCE_ZOP },
    { "JNOP", mi_BRC, { { 0, 0 } }, UNI_ESA_SINCE_ZOP },
    { "JNP", mi_BRC, { { 0, 13 } }, UNI_ESA_SINCE_ZOP },
    { "JNZ", mi_BRC, { { 0, 7 } }, UNI_ESA_SINCE_ZOP },
    { "JO", mi_BRC, { { 0, 1 } }, UNI_ESA_SINCE_ZOP },
    { "JP", mi_BRC, { { 0, 2 } }, UNI_ESA_SINCE_ZOP },
    ...
    { "NHHR", mi_RNSBG, { { 2, 0 }, { 3, 31 } }, UNI_SINCE_Z11 },
    { "NHLR", mi_RNSBG, { { 2, 0 }, { 3, 31 }, { 4, 32 } }, UNI_SINCE_Z11 },
    ...
    { "VCEQB", mi_VCEQ, { { 3, 0 }, { 4, 0 } }, UNI_SINCE_Z13 },
    { "VCEQBS", mi_VCEQ, { { 3, 0 }, { 4, 1 } }, UNI_SINCE_Z13 },
    { "VCEQF", mi_VCEQ, { { 3, 2 }, { 4, 0 } }, UNI_SINCE_Z13 },
    { "VCEQFS", mi_VCEQ, { { 3, 2 }, { 4, 1 } }, UNI_SINCE_Z13 },
    { "VCEQG", mi_VCEQ, { { 3, 3 }, { 4, 0 } }, UNI_SINCE_Z13 },
    { "VCEQGS", mi_VCEQ, { { 3, 3 }, { 4, 1 } }, UNI_SINCE_Z13 },
    { "VCEQH", mi_VCEQ, { { 3, 1 }, { 4, 0 } }, UNI_SINCE_Z13 },
    { "VCEQHS", mi_VCEQ, { { 3, 1 }, { 4, 1 } }, UNI_SINCE_Z13 },
    { "VCFEB", mi_VCSFP, { { 2, 2 } }, UNI_SINCE_Z15 },
    { "VCGD", mi_VCSFP, {}, UNI_SINCE_Z13 },
    { "VCGDB", mi_VCSFP, { { 2, 3 } }, UNI_SINCE_Z13 },
    { "VCHB", mi_VCH, { { 3, 0 }, { 4, 0 } }, UNI_SINCE_Z13 },
    { "VCHBS", mi_VCH, { { 3, 0 }, { 4, 1 } }, UNI_SINCE_Z13 },
    { "VCHF", mi_VCH, { { 3, 2 }, { 4, 0 } }, UNI_SINCE_Z13 },
    { "VCHFS", mi_VCH, { { 3, 2 }, { 4, 1 } }, UNI_SINCE_Z13 },
    { "VCHG", mi_VCH, { { 3, 3 }, { 4, 0 } }, UNI_SINCE_Z13 },
    { "VCHGS", mi_VCH, { { 3, 3 }, { 4, 1 } }, UNI_SINCE_Z13 },
    { "VCHH", mi_VCH, { { 3, 1 }, { 4, 0 } }, UNI_SINCE_Z13 },
    { "VCHHS", mi_VCH, { { 3, 1 }, { 4, 1 } }, UNI_SINCE_Z13 },
    { "VCHLB", mi_VCHL, { { 3, 0 }, { 4, 0 } }, UNI_SINCE_Z13 },
    { "VCHLBS", mi_VCHL, { { 3, 0 }, { 4, 1 } }, UNI_SINCE_Z13 },
    { "VCHLF", mi_VCHL, { { 3, 2 }, { 4, 0 } }, UNI_SINCE_Z13 },
    { "VCHLFS", mi_VCHL, { { 3, 2 }, { 4, 1 } }, UNI_SINCE_Z13 },
    { "VCHLG", mi_VCHL, { { 3, 3 }, { 4, 0 } }, UNI_SINCE_Z13 },
    { "VCHLGS", mi_VCHL, { { 3, 3 }, { 4, 1 } }, UNI_SINCE_Z13 },
    { "VCHLH", mi_VCHL, { { 3, 1 }, { 4, 0 } }, UNI_SINCE_Z13 },
    { "VCHLHS", mi_VCHL, { { 3, 1 }, { 4, 1 } }, UNI_SINCE_Z13 },
    ...
    { "VFADB", mi_VFA, { { 3, 3 }, { 4, 0 } }, UNI_SINCE_Z13 },
    { "VFAEB", mi_VFAE, { { 3, 0 } }, UNI_SINCE_Z13 },
    { "VFAEBS", mi_VFAE, { { 3, 0 } }, UNI_SINCE_Z13 },
    { "VFAEF", mi_VFAE, { { 3, 2 } }, UNI_SINCE_Z13 },
    { "VFAEFS", mi_VFAE, { { 3, 2 } }, UNI_SINCE_Z13 },
    { "VFAEH", mi_VFAE, { { 3, 1 } }, UNI_SINCE_Z13 },
    { "VFAEHS", mi_VFAE, { { 3, 1 } }, UNI_SINCE_Z13 },
    { "VFAEZB", mi_VFAE, { { 3, 0 } }, UNI_SINCE_Z13 },
    { "VFAEZBS", mi_VFAE, { { 3, 0 } }, UNI_SINCE_Z13 },
    { "VFAEZF", mi_VFAE, { { 3, 2 } }, UNI_SINCE_Z13 },
    { "VFAEZFS", mi_VFAE, { { 3, 2 } }, UNI_SINCE_Z13 },
    { "VFAEZH", mi_VFAE, { { 3, 1 } }, UNI_SINCE_Z13 },
    { "VFAEZHS", mi_VFAE, { { 3, 1 } }, UNI_SINCE_Z13 },
    { "VFASB", mi_VFA, { { 3, 2 }, { 4, 0 } }, UNI_SINCE_Z14 },
    { "VFCEDB", mi_VFCE, { { 3, 3 }, { 4, 0 }, { 5, 0 } }, UNI_SINCE_Z13 },
    { "VFCEDBS", mi_VFCE, { { 3, 3 }, { 4, 0 }, { 5, 1 } }, UNI_SINCE_Z13 },
    { "VFCESB", mi_VFCE, { { 3, 2 }, { 4, 0 }, { 5, 0 } }, UNI_SINCE_Z14 },
    { "VFCESBS", mi_VFCE, { { 3, 2 }, { 4, 0 }, { 5, 1 } }, UNI_SINCE_Z14 },
    { "VFCHDB", mi_VFCH, { { 3, 3 }, { 4, 0 }, { 5, 0 } }, UNI_SINCE_Z13 },
    { "VFCHDBS", mi_VFCH, { { 3, 3 }, { 4, 0 }, { 5, 1 } }, UNI_SINCE_Z13 },
    { "VFCHEDB", mi_VFCHE, { { 3, 3 }, { 4, 0 }, { 5, 0 } }, UNI_SINCE_Z13 },
    { "VFCHEDBS", mi_VFCHE, { { 3, 3 }, { 4, 0 }, { 5, 1 } }, UNI_SINCE_Z13 },
    { "VFCHESB", mi_VFCHE, { { 3, 2 }, { 4, 0 }, { 5, 0 } }, UNI_SINCE_Z14 },
    { "VFCHESBS", mi_VFCHE, { { 3, 2 }, { 4, 0 }, { 5, 1 } }, UNI_SINCE_Z14 },
    { "VFCHSB", mi_VFCH, { { 3, 2 }, { 4, 0 }, { 5, 0 } }, UNI_SINCE_Z14 },
    { "VFCHSBS", mi_VFCH, { { 3, 2 }, { 4, 0 }, { 5, 1 } }, UNI_SINCE_Z14 },
    { "VFDDB", mi_VFD, { { 3, 3 }, { 4, 0 } }, UNI_SINCE_Z13 },
    { "VFDSB", mi_VFD, { { 3, 2 }, { 4, 0 } }, UNI_SINCE_Z14 },
    { "VFEEB", mi_VFEE, { { 3, 0 } }, UNI_SINCE_Z13 },
    { "VFEEBS", mi_VFEE, { { 3, 0 }, { 4, 1 } }, UNI_SINCE_Z13 },
    { "VFEEF", mi_VFEE, { { 3, 2 } }, UNI_SINCE_Z13 },
    { "VFEEFS", mi_VFEE, { { 3, 2 }, { 4, 1 } }, UNI_SINCE_Z13 },
    { "VFEEH", mi_VFEE, { { 3, 1 } }, UNI_SINCE_Z13 },
    { "VFEEHS", mi_VFEE, { { 3, 1 }, { 4, 1 } }, UNI_SINCE_Z13 },
    { "VFEEZB", mi_VFEE, { { 3, 0 }, { 4, 2 } }, UNI_SINCE_Z13 },
    { "VFEEZBS", mi_VFEE, { { 3, 0 }, { 4, 3 } }, UNI_SINCE_Z13 },
    { "VFEEZF", mi_VFEE, { { 3, 2 }, { 4, 2 } }, UNI_SINCE_Z13 },
    { "VFEEZFS", mi_VFEE, { { 3, 2 }, { 4, 3 } }, UNI_SINCE_Z13 },
    { "VFEEZH", mi_VFEE, { { 3, 1 }, { 4, 2 } }, UNI_SINCE_Z13 },
    { "VFEEZHS", mi_VFEE, { { 3, 1 }, { 4, 3 } }, UNI_SINCE_Z13 },
    { "VFENEB", mi_VFENE, { { 3, 0 } }, UNI_SINCE_Z13 },
    { "VFENEBS", mi_VFENE, { { 3, 0 }, { 4, 1 } }, UNI_SINCE_Z13 },
    { "VFENEF", mi_VFENE, { { 3, 2 } }, UNI_SINCE_Z13 },
    { "VFENEFS", mi_VFENE, { { 3, 2 }, { 4, 1 } }, UNI_SINCE_Z13 },
    { "VFENEH", mi_VFENE, { { 3, 1 } }, UNI_SINCE_Z13 },
    { "VFENEHS", mi_VFENE, { { 3, 1 }, { 4, 1 } }, UNI_SINCE_Z13 },
    { "VFENEZB", mi_VFENE, { { 3, 0 }, { 4, 2 } }, UNI_SINCE_Z13 },
    { "VFENEZBS", mi_VFENE, { { 3, 0 }, { 4, 3 } }, UNI_SINCE_Z13 },
    { "VFENEZF", mi_VFENE, { { 3, 2 }, { 4, 2 } }, UNI_SINCE_Z13 },
    { "VFENEZFS", mi_VFENE, { { 3, 2 }, { 4, 3 } }, UNI_SINCE_Z13 },
    { "VFENEZH", mi_VFENE, { { 3, 1 }, { 4, 2 } }, UNI_SINCE_Z13 },
    { "VFENEZHS", mi_VFENE, { { 3, 1 }, { 4, 3 } }, UNI_SINCE_Z13 },
    { "VFIDB", mi_VFI, { { 2, 3 } }, UNI_SINCE_Z13 },
    { "VFISB", mi_VFI, { { 2, 2 } }, UNI_SINCE_Z14 },
    { "VFKEDB", mi_VFCE, { { 3, 3 }, { 4, 4 }, { 5, 0 } }, UNI_SINCE_Z14 },
    { "VFKEDBS", mi_VFCE, { { 3, 3 }, { 4, 4 }, { 5, 1 } }, UNI_SINCE_Z14 },
    { "VFKESB", mi_VFCE, { { 3, 2 }, { 4, 4 }, { 5, 0 } }, UNI_SINCE_Z14 },
    { "VFKESBS", mi_VFCE, { { 3, 2 }, { 4, 4 }, { 5, 1 } }, UNI_SINCE_Z14 },
    { "VFKHDB", mi_VFCH, { { 3, 3 }, { 4, 4 }, { 5, 0 } }, UNI_SINCE_Z14 },
    { "VFKHDBS", mi_VFCH, { { 3, 3 }, { 4, 4 }, { 5, 1 } }, UNI_SINCE_Z14 },
    { "VFKHEDB", mi_VFCHE, { { 3, 3 }, { 4, 4 }, { 5, 0 } }, UNI_SINCE_Z14 },
    { "VFKHEDBS", mi_VFCHE, { { 3, 3 }, { 4, 4 }, { 5, 1 } }, UNI_SINCE_Z14 },
    { "VFKHESB", mi_VFCHE, { { 3, 2 }, { 4, 4 }, { 5, 0 } }, UNI_SINCE_Z14 },
    { "VFKHESBS", mi_VFCHE, { { 3, 2 }, { 4, 4 }, { 5, 1 } }, UNI_SINCE_Z14 },
    { "VFKHSB", mi_VFCH, { { 3, 2 }, { 4, 4 }, { 5, 0 } }, UNI_SINCE_Z14 },
    { "VFKHSBS", mi_VFCH, { { 3, 2 }, { 4, 4 }, { 5, 1 } }, UNI_SINCE_Z14 },
    { "VFLCDB", mi_VFPSO, { { 2, 3 }, { 3, 0 }, { 4, 0 } }, UNI_SINCE_Z13 },
    { "VFLCSB", mi_VFPSO, { { 2, 2 }, { 3, 0 }, { 4, 0 } }, UNI_SINCE_Z14 },
    { "VFLLS", mi_VFLL, { { 2, 2 }, { 3, 0 } }, UNI_SINCE_Z14 },
    { "VFLNDB", mi_VFPSO, { { 2, 3 }, { 3, 0 }, { 4, 1 } }, UNI_SINCE_Z13 },
    { "VFLNSB", mi_VFPSO, { { 2, 2 }, { 3, 0 }, { 4, 1 } }, UNI_SINCE_Z14 },
    { "VFLPDB", mi_VFPSO, { { 2, 3 }, { 3, 0 }, { 4, 2 } }, UNI_SINCE_Z13 },
    { "VFLPSB", mi_VFPSO, { { 2, 2 }, { 3, 0 }, { 4, 2 } }, UNI_SINCE_Z14 },
    { "VFLRD", mi_VFLR, { { 2, 3 } }, UNI_SINCE_Z14 },
    { "VFMADB", mi_VFMA, { { 4, 0 }, { 5, 3 } }, UNI_SINCE_Z13 },
    { "VFMASB", mi_VFMA, { { 4, 0 }, { 5, 2 } }, UNI_SINCE_Z14 },
    { "VFMAXDB", mi_VFMAX, { { 3, 3 }, { 4, 0 } }, UNI_SINCE_Z14 },
    { "VFMAXSB", mi_VFMAX, { { 3, 2 }, { 4, 0 } }, UNI_SINCE_Z14 },
    { "VFMDB", mi_VFM, { { 3, 3 }, { 4, 0 } }, UNI_SINCE_Z13 },
    { "VFMINDB", mi_VFMIN, { { 3, 3 }, { 4, 0 } }, UNI_SINCE_Z14 },
    { "VFMINSB", mi_VFMIN, { { 3, 2 }, { 4, 0 } }, UNI_SINCE_Z14 },
    { "VFMSB", mi_VFM, { { 3, 2 }, { 4, 0 } }, UNI_SINCE_Z14 },
    { "VFMSDB", mi_VFMS, { { 4, 0 }, { 5, 3 } }, UNI_SINCE_Z13 },
    { "VFMSSB", mi_VFMS, { { 4, 0 }, { 5, 2 } }, UNI_SINCE_Z14 },
    { "VFNMADB", mi_VFNMA, { { 4, 0 }, { 5, 3 } }, UNI_SINCE_Z14 },
    { "VFNMASB", mi_VFNMA, { { 4, 0 }, { 5, 2 } }, UNI_SINCE_Z14 },
    { "VFNMSDB", mi_VFNMS, { { 4, 0 }, { 5, 3 } }, UNI_SINCE_Z14 },
    { "VFNMSSB", mi_VFNMS, { { 4, 0 }, { 5, 2 } }, UNI_SINCE_Z14 },
    { "VFPSODB", mi_VFPSO, { { 2, 3 }, { 3, 0 } }, UNI_SINCE_Z13 },
    { "VFPSOSB", mi_VFPSO, { { 2, 2 }, { 3, 0 } }, UNI_SINCE_Z14 },
    { "VFSDB", mi_VFS, { { 2, 3 }, { 3, 0 } }, UNI_SINCE_Z13 },
    { "VFSQDB", mi_VFSQ, { { 2, 3 }, { 3, 0 } }, UNI_SINCE_Z13 },
    { "VFSQSB", mi_VFSQ, { { 2, 2 }, { 3, 0 } }, UNI_SINCE_Z14 },
    { "VFSSB", mi_VFS, { { 2, 2 }, { 3, 0 } }, UNI_SINCE_Z14 },
    { "VFTCIDB", mi_VFTCI, { { 3, 3 }, { 4, 0 } }, UNI_SINCE_Z13 },
    { "VFTCISB", mi_VFTCI, { { 3, 2 }, { 4, 0 } }, UNI_SINCE_Z14 },
    ...
    { "VLDEB", mi_VFLL, { { 2, 2 }, { 3, 0 } }, UNI_SINCE_Z13 },
    ...
    { "VPKLSF", mi_VPKLS, { { 3, 2 }, { 4, 0 } }, UNI_SINCE_Z13 },
    { "VPKLSFS", mi_VPKLS, { { 3, 2 }, { 4, 1 } }, UNI_SINCE_Z13 },
    { "VPKLSG", mi_VPKLS, { { 3, 3 }, { 4, 0 } }, UNI_SINCE_Z13 },
    { "VPKLSGS", mi_VPKLS, { { 3, 3 }, { 4, 1 } }, UNI_SINCE_Z13 },
    { "VPKLSH", mi_VPKLS, { { 3, 1 }, { 4, 0 } }, UNI_SINCE_Z13 },
    { "VPKLSHS", mi_VPKLS, { { 3, 1 }, { 4, 1 } }, UNI_SINCE_Z13 },
    { "VPKSF", mi_VPKS, { { 3, 2 }, { 4, 0 } }, UNI_SINCE_Z13 },
    { "VPKSFS", mi_VPKS, { { 3, 2 }, { 4, 1 } }, UNI_SINCE_Z13 },
    { "VPKSG", mi_VPKS, { { 3, 3 }, { 4, 0 } }, UNI_SINCE_Z13 },
    { "VPKSGS", mi_VPKS, { { 3, 3 }, { 4, 1 } }, UNI_SINCE_Z13 },
    { "VPKSH", mi_VPKS, { { 3, 1 }, { 4, 0 } }, UNI_SINCE_Z13 },
    { "VPKSHS", mi_VPKS, { { 3, 1 }, { 4, 1 } }, UNI_SINCE_Z13 },
    ...
    { "VSTRCBS", mi_VSTRC, { { 4, 0 } }, UNI_SINCE_Z13 },
    { "VSTRCF", mi_VSTRC, { { 4, 2 } }, UNI_SINCE_Z13 },
    { "VSTRCFS", mi_VSTRC, { { 4, 2 } }, UNI_SINCE_Z13 },
    { "VSTRCH", mi_VSTRC, { { 4, 1 } }, UNI_SINCE_Z13 },
    { "VSTRCHS", mi_VSTRC, { { 4, 1 } }, UNI_SINCE_Z13 },
    { "VSTRCZB", mi_VSTRC, { { 4, 0 } }, UNI_SINCE_Z13 },
    { "VSTRCZBS", mi_VSTRC, { { 4, 0 } }, UNI_SINCE_Z13 },
    { "VSTRCZF", mi_VSTRC, { { 4, 2 } }, UNI_SINCE_Z13 },
    { "VSTRCZFS", mi_VSTRC, { { 4, 2 } }, UNI_SINCE_Z13 },
    { "VSTRCZH", mi_VSTRC, { { 4, 1 } }, UNI_SINCE_Z13 },
    { "VSTRCZHS", mi_VSTRC, { { 4, 1 } }, UNI_SINCE_Z13 },
    { "VSTRSB", mi_VSTRS, { { 4, 0 } }, UNI_SINCE_Z15 },
    { "VSTRSF", mi_VSTRS, { { 4, 2 } }, UNI_SINCE_Z15 },
    { "VSTRSH", mi_VSTRS, { { 4, 1 } }, UNI_SINCE_Z15 },
    { "VSTRSZB", mi_VSTRS, { { 4, 0 }, { 5, 2 } }, UNI_SINCE_Z15 },
    ...
    { "VZERO", mi_VGBM, { { 0, 1 } }, UNI_SINCE_Z13 },
    { "WCDGB", mi_VCFPS, { { 2, 3 } }, UNI_SINCE_Z13 },
    { "WCDLGB", mi_VCFPL, { { 2, 3 } }, UNI_SINCE_Z13 },
    { "WCEFB", mi_VCFPS, { { 2, 2 } }, UNI_SINCE_Z15 },
    { "WCELFB", mi_VCFPL, { { 2, 2 } }, UNI_SINCE_Z15 },
    { "WCFEB", mi_VCSFP, { { 2, 2 } }, UNI_SINCE_Z15 },
    { "WCGDB", mi_VCSFP, { { 2, 3 } }, UNI_SINCE_Z13 },
    { "WCLFEB", mi_VCLFP, { { 2, 2 } }, UNI_SINCE_Z15 },
    { "WCLGDB", mi_VCLGD, { { 2, 3 } }, UNI_SINCE_Z13 },
    { "WFADB", mi_VFA, { { 3, 3 }, { 4, 8 } }, UNI_SINCE_Z13 },
    { "WFASB", mi_VFA, { { 3, 2 }, { 4, 8 } }, UNI_SINCE_Z14 },
    { "WFAXB", mi_VFA, { { 3, 4 }, { 4, 8 } }, UNI_SINCE_Z14 },
    { "WFCDB", mi_WFC, { { 3, 3 }, { 4, 0 } }, UNI_SINCE_Z13 },
    { "WFCEDB", mi_VFCE, { { 3, 3 }, { 4, 8 }, { 5, 0 } }, UNI_SINCE_Z13 },
    { "WFCEDBS", mi_VFCE, { { 3, 3 }, { 4, 8 }, { 5, 1 } }, UNI_SINCE_Z13 },
    { "WFCESB", mi_VFCE, { { 3, 2 }, { 4, 8 }, { 5, 0 } }, UNI_SINCE_Z14 },
    { "WFCESBS", mi_VFCE, { { 3, 2 }, { 4, 8 }, { 5, 1 } }, UNI_SINCE_Z14 },
    { "WFCEXB", mi_VFCE, { { 3, 4 }, { 4, 8 }, { 5, 0 } }, UNI_SINCE_Z14 },
    { "WFCEXBS", mi_VFCE, { { 3, 4 }, { 4, 8 }, { 5, 1 } }, UNI_SINCE_Z14 },
    { "WFCHDB", mi_VFCH, { { 3, 3 }, { 4, 8 }, { 5, 0 } }, UNI_SINCE_Z13 },
    { "WFCHDBS", mi_VFCH, { { 3, 3 }, { 4, 8 }, { 5, 1 } }, UNI_SINCE_Z13 },
    { "WFCHEDB", mi_VFCHE, { { 3, 3 }, { 4, 8 }, { 5, 0 } }, UNI_SINCE_Z13 },
    { "WFCHEDBS", mi_VFCHE, { { 3, 3 }, { 4, 8 }, { 5, 1 } }, UNI_SINCE_Z13 },
    { "WFCHESB", mi_VFCHE, { { 3, 2 }, { 4, 8 }, { 5, 0 } }, UNI_SINCE_Z14 },
    { "WFCHESBS", mi_VFCHE, { { 3, 2 }, { 4, 8 }, { 5, 1 } }, UNI_SINCE_Z14 },
    { "WFCHEXB", mi_VFCHE, { { 3, 4 }, { 4, 8 }, { 5, 0 } }, UNI_SINCE_Z14 },
    { "WFCHEXBS", mi_VFCHE, { { 3, 4 }, { 4, 8 }, { 5, 1 } }, UNI_SINCE_Z14 },
    { "WFCHSB", mi_VFCH, { { 3, 2 }, { 4, 8 }, { 5, 0 } }, UNI_SINCE_Z14 },
    { "WFCHSBS", mi_VFCH, { { 3, 2 }, { 4, 8 }, { 5, 1 } }, UNI_SINCE_Z14 },
    { "WFCHXB", mi_VFCH, { { 3, 4 }, { 4, 8 }, { 5, 0 } }, UNI_SINCE_Z14 },
    { "WFCHXBS", mi_VFCH, { { 3, 4 }, { 4, 8 }, { 5, 1 } }, UNI_SINCE_Z14 },
    { "WFCSB", mi_WFC, { { 3, 2 }, { 4, 0 } }, UNI_SINCE_Z14 },
    { "WFCXB", mi_WFC, { { 3, 4 }, { 4, 0 } }, UNI_SINCE_Z14 },
    { "WFDDB", mi_VFD, { { 3, 3 }, { 4, 8 } }, UNI_SINCE_Z13 },
    { "WFDSB", mi_VFD, { { 3, 2 }, { 4, 8 } }, UNI_SINCE_Z14 },
    { "WFDXB", mi_VFD, { { 3, 4 }, { 4, 8 } }, UNI_SINCE_Z14 },
    { "WFIDB", mi_VFI, { { 2, 3 } }, UNI_SINCE_Z13 },
    { "WFISB", mi_VFI, { { 2, 2 } }, UNI_SINCE_Z14 },
    { "WFIXB", mi_VFI, { { 2, 4 } }, UNI_SINCE_Z14 },
    { "WFKDB", mi_WFK, { { 3, 3 }, { 4, 0 } }, UNI_SINCE_Z13 },
    { "WFKEDB", mi_VFCE, { { 3, 3 }, { 4, 12 }, { 5, 0 } }, UNI_SINCE_Z14 },
    { "WFKEDBS", mi_VFCE, { { 3, 3 }, { 4, 12 }, { 5, 1 } }, UNI_SINCE_Z14 },
    { "WFKESB", mi_VFCE, { { 3, 2 }, { 4, 12 }, { 5, 0 } }, UNI_SINCE_Z14 },
    { "WFKESBS", mi_VFCE, { { 3, 2 }, { 4, 12 }, { 5, 1 } }, UNI_SINCE_Z14 },
    { "WFKEXB", mi_VFCE, { { 3, 4 }, { 4, 12 }, { 5, 0 } }, UNI_SINCE_Z14 },
    { "WFKEXBS", mi_VFCE, { { 3, 4 }, { 4, 12 }, { 5, 1 } }, UNI_SINCE_Z14 },
    { "WFKHDB", mi_VFCH, { { 3, 3 }, { 4, 12 }, { 5, 0 } }, UNI_SINCE_Z14 },
    { "WFKHDBS", mi_VFCH, { { 3, 3 }, { 4, 12 }, { 5, 1 } }, UNI_SINCE_Z14 },
    { "WFKHEDB", mi_VFCHE, { { 3, 3 }, { 4, 12 }, { 5, 0 } }, UNI_SINCE_Z14 },
    { "WFKHEDBS", mi_VFCHE, { { 3, 3 }, { 4, 12 }, { 5, 1 } }, UNI_SINCE_Z14 },
    { "WFKHESB", mi_VFCHE, { { 3, 2 }, { 4, 12 }, { 5, 0 } }, UNI_SINCE_Z14 },
    { "WFKHESBS", mi_VFCHE, { { 3, 2 }, { 4, 12 }, { 5, 1 } }, UNI_SINCE_Z14 },
    { "WFKHEXB", mi_VFCHE, { { 3, 4 }, { 4, 12 }, { 5, 0 } }, UNI_SINCE_Z14 },
    { "WFKHEXBS", mi_VFCHE, { { 3, 4 }, { 4, 12 }, { 5, 1 } }, UNI_SINCE_Z14 },
    { "WFKHSB", mi_VFCH, { { 3, 2 }, { 4, 12 }, { 5, 0 } }, UNI_SINCE_Z14 },
    { "WFKHSBS", mi_VFCH, { { 3, 2 }, { 4, 12 }, { 5, 1 } }, UNI_SINCE_Z14 },
    { "WFKHXB", mi_VFCH, { { 3, 4 }, { 4, 12 }, { 5, 0 } }, UNI_SINCE_Z14 },
    { "WFKHXBS", mi_VFCH, { { 3, 4 }, { 4, 12 }, { 5, 1 } }, UNI_SINCE_Z14 },
    { "WFKSB", mi_WFK, { { 3, 2 }, { 4, 0 } }, UNI_SINCE_Z14 },
    { "WFKXB", mi_WFK, { { 3, 4 }, { 4, 0 } }, UNI_SINCE_Z14 },
    { "WFLCDB", mi_VFPSO, { { 2, 3 }, { 3, 8 }, { 4, 0 } }, UNI_SINCE_Z13 },
    { "WFLCSB", mi_VFPSO, { { 2, 2 }, { 3, 8 }, { 4, 0 } }, UNI_SINCE_Z14 },
    { "WFLCXB", mi_VFPSO, { { 2, 4 }, { 3, 8 }, { 4, 0 } }, UNI_SINCE_Z14 },
    { "WFLLD", mi_VFLL, { { 2, 3 }, { 3, 8 } }, UNI_SINCE_Z14 },
    { "WFLLS", mi_VFLL, { { 2, 2 }, { 3, 8 } }, UNI_SINCE_Z14 },
    { "WFLNDB", mi_VFPSO, { { 2, 3 }, { 3, 8 }, { 4, 1 } }, UNI_SINCE_Z13 },
    { "WFLNSB", mi_VFPSO, { { 2, 2 }, { 3, 8 }, { 4, 1 } }, UNI_SINCE_Z14 },
    { "WFLNXB", mi_VFPSO, { { 2, 4 }, { 3, 8 }, { 4, 1 } }, UNI_SINCE_Z14 },
    { "WFLPDB", mi_VFPSO, { { 2, 3 }, { 3, 8 }, { 4, 2 } }, UNI_SINCE_Z13 },
    { "WFLPSB", mi_VFPSO, { { 2, 2 }, { 3, 8 }, { 4, 2 } }, UNI_SINCE_Z14 },
    { "WFLPXB", mi_VFPSO, { { 2, 4 }, { 3, 8 }, { 4, 2 } }, UNI_SINCE_Z14 },
    { "WFLRD", mi_VFLR, { { 2, 3 } }, UNI_SINCE_Z14 },
    { "WFLRX", mi_VFLR, { { 2, 4 } }, UNI_SINCE_Z14 },
    { "WFMADB", mi_VFMA, { { 4, 8 }, { 5, 3 } }, UNI_SINCE_Z13 },
    { "WFMASB", mi_VFMA, { { 4, 8 }, { 5, 2 } }, UNI_SINCE_Z14 },
    { "WFMAXB", mi_VFMA, { { 4, 8 }, { 5, 4 } }, UNI_SINCE_Z14 },
    { "WFMAXDB", mi_VFMAX, { { 3, 3 }, { 4, 8 } }, UNI_SINCE_Z14 },
    { "WFMAXSB", mi_VFMAX, { { 3, 2 }, { 4, 8 } }, UNI_SINCE_Z14 },
    { "WFMAXXB", mi_VFMAX, { { 3, 4 }, { 4, 8 } }, UNI_SINCE_Z14 },
    { "WFMDB", mi_VFM, { { 3, 3 }, { 4, 8 } }, UNI_SINCE_Z13 },
    { "WFMINDB", mi_VFMIN, { { 3, 3 }, { 4, 8 } }, UNI_SINCE_Z14 },
    { "WFMINSB", mi_VFMIN, { { 3, 2 }, { 4, 8 } }, UNI_SINCE_Z14 },
    { "WFMINXB", mi_VFMIN, { { 3, 4 }, { 4, 8 } }, UNI_SINCE_Z14 },
    { "WFMSB", mi_VFM, { { 3, 2 }, { 4, 8 } }, UNI_SINCE_Z14 },
    { "WFMSDB", mi_VFMS, { { 4, 8 }, { 5, 3 } }, UNI_SINCE_Z13 },
    { "WFMSSB", mi_VFMS, { { 4, 8 }, { 5, 2 } }, UNI_SINCE_Z14 },
    { "WFMSXB", mi_VFMS, { { 4, 8 }, { 5, 4 } }, UNI_SINCE_Z14 },
    { "WFMXB", mi_VFM, { { 3, 4 }, { 4, 8 } }, UNI_SINCE_Z14 },
    { "WFNMADB", mi_VFNMA, { { 4, 8 }, { 5, 3 } }, UNI_SINCE_Z14 },
    { "WFNMASB", mi_VFNMA, { { 4, 8 }, { 5, 2 } }, UNI_SINCE_Z14 },
    { "WFNMAXB", mi_VFNMA, { { 4, 8 }, { 5, 4 } }, UNI_SINCE_Z14 },
    { "WFNMSDB", mi_VFNMS, { { 4, 8 }, { 5, 3 } }, UNI_SINCE_Z14 },
    { "WFNMSSB", mi_VFNMS, { { 4, 8 }, { 5, 2 } }, UNI_SINCE_Z14 },
    { "WFNMSXB", mi_VFNMS, { { 4, 8 }, { 5, 4 } }, UNI_SINCE_Z14 },
    { "WFPSODB", mi_VFPSO, { { 2, 3 }, { 3, 8 } }, UNI_SINCE_Z13 },
    { "WFPSOSB", mi_VFPSO, { { 2, 2 }, { 3, 8 } }, UNI_SINCE_Z14 },
    { "WFPSOXB", mi_VFPSO, { { 2, 4 }, { 3, 8 } }, UNI_SINCE_Z14 },
    { "WFSDB", mi_VFS, { { 2, 3 }, { 3, 8 } }, UNI_SINCE_Z13 },
    { "WFSQDB", mi_VFSQ, { { 2, 3 }, { 3, 8 } }, UNI_SINCE_Z13 },
    { "WFSQSB", mi_VFSQ, { { 2, 2 }, { 3, 8 } }, UNI_SINCE_Z14 },
    { "WFSQXB", mi_VFSQ, { { 2, 4 }, { 3, 8 } }, UNI_SINCE_Z14 },
    { "WFSSB", mi_VFS, { { 2, 2 }, { 3, 8 } }, UNI_SINCE_Z14 },
    { "WFSXB", mi_VFS, { { 2, 4 }, { 3, 8 } }, UNI_SINCE_Z14 },
    { "WFTCIDB", mi_VFTCI, { { 3, 3 }, { 4, 8 } }, UNI_SINCE_Z13 },
    { "WFTCISB", mi_VFTCI, { { 3, 2 }, { 4, 8 } }, UNI_SINCE_Z14 },
    { "WFTCIXB", mi_VFTCI, { { 3, 4 }, { 4, 8 } }, UNI_SINCE_Z14 },
    { "WLDEB", mi_VFLL, { { 2, 2 }, { 3, 8 } }, UNI_SINCE_Z13 },
    { "WLEDB", mi_VFLR, { { 2, 3 } }, UNI_SINCE_Z13 },
    { "XHHR", mi_RXSBG, { { 2, 0 }, { 3, 31 } }, UNI_SINCE_Z11 },
    { "XHLR", mi_RXSBG, { { 2, 0 }, { 3, 31 }, { 4, 32 } }, UNI_SINCE_Z11 },
    { "XLHR", mi_RXSBG, { { 2, 32 }, { 3, 63 }, { 4, 32 } }, UNI_SINCE_Z11 },
};
