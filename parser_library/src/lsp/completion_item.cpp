...
namespace {
std::set<completion_item_s, completion_item_s::label_comparer> get_completion_items(
    std::shared_ptr<context::hlasm_context> h_ctx)
{
    using namespace context;

    const auto& instr_map = h_ctx->instruction_map();

    static std::set<completion_item_s, completion_item_s::label_comparer> items;
...
instruction_completion_items::instruction_completion_items(std::shared_ptr<context::hlasm_context> h_ctx)
    : data([h_ctx]() { return get_completion_items(h_ctx); }())
{}
