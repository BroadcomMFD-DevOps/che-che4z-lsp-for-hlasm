...
public:
    virtual bool check(std::span<const asm_operand*>, const range&, const diagnostic_collector&) const = 0;
...
protected:
    ...
    bool operands_size_corresponding(std::span<const asm_operand*> to_check,
