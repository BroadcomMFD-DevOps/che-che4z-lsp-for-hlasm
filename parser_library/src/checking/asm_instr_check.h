...
public:
    ...
    bool check(std::span<const asm_operand*> to_check,
...
public:
    ...
    bool check(
        std::span<const asm_operand*> to_check, const range& stmt_range, const diagnostic_collector&) const override;
};
...
protected:
    ...
    bool check_data(std::span<const asm_operand*> to_check, const range& stmt_range, const diagnostic_collector&) const;
};
