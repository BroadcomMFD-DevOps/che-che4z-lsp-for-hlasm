...
struct diagnostic_op
{
    ...
    static diagnostic_op error_M120(std::string_view instr_name, const range& range, std::string_view qual = "");
    ...
    static diagnostic_op error_M124(std::string_view instr_name, const range& range, std::string_view qual = "");
