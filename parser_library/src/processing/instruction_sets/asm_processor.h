...
private:
    ...
    void process_ENTRY(rebuilt_statement&& stmt, const processing_status& status);
    void process_ADATA(rebuilt_statement&& stmt, const processing_status& status);
    ...
    void add_postponed(rebuilt_statement&& stmt, const processing_status& status) const;
};
